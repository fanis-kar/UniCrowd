    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Universities",
                columns: new[] { "Id", "Abbreviation", "AccountId", "Address", "Name", "Phone", "Website" },
                values: new object[] { 2, "aueb", 2, "Πατησίων 76, Αθήνα 104 34", "Οικονομικό Πανεπιστήμιο Αθηνών", "+302108203911", "https://www.aueb.gr" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, "sde", "sde@aueb.gr", "Σχολή Διοίκησης Επιχειρήσεων", "+302108214510", 2, "https://www.dept.aueb.gr/el/school_of_business" },
                    { 8, "soe", "secr_soe@aueb.gr", "Σχολή Οικονομικών Επιστημών", "+302108203416", 2, "https://www.dept.aueb.gr/el/school_of_economics" },
                    { 9, "soi", "webmaster@aueb.gr", "Σχολή Επιστημών και Τεχνολογίας της Πληροφορίας", "+302108203911", 2, "https://www.dept.aueb.gr/el/school_of_informatics" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 28, "ode", "ode@aueb.gr", 7, "Τμήμα Οργάνωσης και Διοίκησης Επιχειρήσεων", "+302108203308", "https://www.dept.aueb.gr/ode" },
                    { 29, "mbv", "secretary.marketing@aueb.gr", 7, "Τμήμα Μάρκετινγκ και Επικοινωνίας", "+302108203101", "https://www.dept.aueb.gr/mbc" },
                    { 30, "loxri", "accfin@aueb.gr", 7, "Τμήμα Λογιστικής και Χρηματοοικονομικής", "+302108203300", "https://www.dept.aueb.gr/loxri" },
                    { 31, "dmst", "dmst@aueb.gr", 7, "Τμήμα Διοικητικής Επιστήμης και Τεχνολογίας", "+302108203129", "https://www.dept.aueb.gr/dmst" },
                    { 32, "econ", "econ@aueb.gr", 8, "Τμήμα Οικονομικής Επιστήμης", "+302108203303", "https://www.dept.aueb.gr/econ" },
                    { 33, "deos", "deossecr@aueb.gr", 8, "Τμήμα Διεθνών και Ευρωπαϊκών Οικονομικών Σπουδών", "+302108203106", "https://www.dept.aueb.gr/deos" },
                    { 27, "civ", "civ@uniwa.gr", 6, "Τμήμα Πολιτικών Μηχανικών", "+302105381215", "http://civ.uniwa.gr/" },
                    { 34, "cs", "infotech@aueb.gr", 9, "Τμήμα Πληροφορικής", "+302108203315", "https://www.dept.aueb.gr/cs" },
                    ...
                    { 35, "stat", "stat@aueb.gr", 9, "Τμήμα Στατιστικής", "+302108203112", "https://www.dept.aueb.gr/stat" }
                });
